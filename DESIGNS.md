...
접근성 + Material Design 3 + TruthScope 토큰 통합 안내서
...
TruthScope는 뉴스 신뢰도를 분석하는 서비스입니다. 시각 장애인, 키보드만 사용하는 사람, 색각 이상자 등 다양한 사람이 사용할 수 있어야 합니다.

> KWCAG 2.2 (한국형 웹 접근성 지침): 4원칙 · 14지침 · 33항목 | 디지털포용법 제21조

아래는 TruthScope에 직접 적용해야 하는 항목만 추린 것입니다.
...
// Good: 의미 있는 alt
<img src="/logo.svg" alt="TruthScope 로고" />
...
- M3 권장 (TruthScope 채택): 48 x 48 dp
...
6/10/20은 M3 정규 8dp 그리드에 없는 TruthScope 내부 확장값입니다. 12, 14, 15, 18px 등은 사용할 수 없습니다.
...
TruthScope는 M3를 기본 설계 기준으로 채택합니다. Primer와 Carbon은 접근성 패턴 및 색상 역할 참고용입니다.
...
- 심화 레퍼런스: `docs/guides/truthscope-design-system-references.md`
